...
if __name__ == "__main__":
    ...
    batch_size = 32
    if method=="gold":
        dataset_name = f"{user_id}/{method}-imdb-ppo-clustering-eval-seed{seed}"
    elif method == "maxmin":
        dataset_name = f"{user_id}/{method}-imdb-ppo-clustering-eval-prop{proportion}-seed{seed}"
    elif method == "sharedrep":
        dataset_name = f"{user_id}/{method}-imdb-ppo-clustering-eval-prop{proportion}-seed{seed}-k{k}"
